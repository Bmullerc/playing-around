      ...
      <main className='bg-stone-100'>
        ...
        <header className='flex flex-col gap-6 justify-center items-center h-96 bg-gradient-to-tl from-stone-700 to-stone-600'>
          ...
          <div className='flex gap-4'>
            <button className='bg-orange-500 py-2 px-3 rounded-md text-stone-50 font-bold hover:bg-orange-50 hover:text-orange-600 hover:scale-95 duration-200' onClick={() => setIsActive("posts")}>Posts</button>
            <button className='bg-orange-500 py-2 px-3 rounded-md text-stone-50 font-bold hover:bg-orange-50 hover:text-orange-600 hover:scale-95 duration-200' onClick={() => setIsActive("albums")}>Albums</button>
            <button className='bg-orange-500 py-2 px-3 rounded-md text-stone-50 font-bold hover:bg-orange-50 hover:text-orange-600 hover:scale-95 duration-200' onClick={() => setIsActive("todos")}>Todos</button>
          </div>
